...
export type BRDStatus = "pending" | "in-progress" | "completed";

interface BRDStatusIndicatorProps {
  status: BRDStatus;
}

export const BRDStatusIndicator: React.FC<BRDStatusIndicatorProps> = ({
  status,
}) => {
...
export default BRDStatusIndicator;
